...
const ExternalLinks = ({ githubUrl, externalUrl }) => {
  return (
    <div
      className="flex gap-4 justify-center mb-8 animate-fade-in-up"
    >
      {githubUrl && (
        <a
          href={githubUrl}
          ...
          className="flex items-center gap-3 border border-gray-700/50 px-6 py-3 rounded-full backdrop-blur-sm 
                     hover:bg-gray-800/70 transition-transform duration-300 active:scale-95"
        >
          <svg
      ...
      {externalUrl && (
        ...
        >
          ...
          <span className="text-black group-hover:text-white font-medium transition-colors duration-300 relative z-10">
            Visitar
          </span>
        </a>
      )}
